            ...
            <div className="md:justify-between md:gap-16 mt-32">
                ...
                >
                    <div className="relative">
                        <div className="z-10">
                            <p className="font-playfair font-semibold text-5xl">Relevant Work Experiences</p>
                            <p className="text-lruby font-playfair font-semibold text-2xl mt-3">Barista, Shift Supervisor, Certified Barista Trainer</p>
                            <p className="font-playfair font-semibold text-x3 mt-3">Starbucks</p>
                ...
                >
                    <div className="relative">
                        <div className="z-10">
                            <p className="text-lruby font-playfair font-semibold text-2xl mt-3">Co-editor/writer of a research paper/design</p>
                            <p className="font-playfair font-semibold text-x3 mt-3">University of California, Riverside</p>
                ...
                >
                    <div className="relative h-32">
                        <div className="z-10">
                        <p className="font-playfair font-semibold text-5xl">Education</p>
                        <p className="text-lruby font-playfair font-semibold text-2xl mt-3">University of California, Riverside</p>
                            <p className="font-playfair font-semibold text-x3 mt-3">Bachelor of Science</p>
                        </div>
                    </div>
                ...
                >
                    <div className="relative">
                        <div className="z-10">
                            <p className="text-lruby font-playfair font-semibold text-2xl mt-3">University of California, Riverside Extension</p>
                            <p className="font-playfair font-semibold text-x3 mt-3">Web Development Certification</p>
